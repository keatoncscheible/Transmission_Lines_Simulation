...
function handles = setup_gui
    ...
    % File
    handles.tline_settings_file = uimenu(...
        'Parent',handles.tline_settings_fig,...
        'Label','File');
    
    % Source
    handles.tline_settings_source = uimenu(...
        'Parent',handles.tline_settings_fig,...
        'Label','Source');

    % Line
    handles.tline_settings_line = uimenu(...
        'Parent',handles.tline_settings_fig,...
        'Label','Line');
    ...
    % Animation
    handles.tline_settings_animation = uimenu(...
        'Parent',handles.tline_settings_fig,...
        'Label','Animation');
    
    % Help
    handles.tline_settings_help = uimenu(...
        'Parent',handles.tline_settings_fig,...
        'Label','Help');
    
        
    %% Create Transmission Line Settings File Menu
    
    % File => Save
    handles.tline_settings_file_save = uimenu(...
        'Parent',handles.tline_settings_file,...
        'Label','Save',...
        'Accelerator','S',...
        'Callback',@tline_settings_file_save_callback);
    
    % File => Save As
    handles.tline_settings_file_save_as = uimenu(...
        'Parent',handles.tline_settings_file,...
        'Label','Save As',...
        'Callback',@tline_settings_file_save_as_callback);
    
    % File => Add Note
    handles.tline_settings_file_add_note = uimenu(...
        'Parent',handles.tline_settings_file,...
        'Label','Add Note',...
        'Callback',@tline_settings_file_add_note_callback);
    
    % File => Print to File
    handles.tline_settings_file_print = uimenu(...
        'Parent',handles.tline_settings_file,...
        'Label','Print to File',...
        'Separator','on',...
        'Callback',@tline_settings_file_print_callback);
    
    % File => Predefined Configurations
    handles.tline_settings_file_preconfig = uimenu(...
        'Parent',handles.tline_settings_file,...
        'Label','Predefined Configurations',...
        'Separator','on');
    
    % File => Predefined Configurations => Transient
    handles.tline_settings_file_preconfig_transient = uimenu(...
        'Parent',handles.tline_settings_file_preconfig,...
        'Label','Transient');
    
    % File => Predefined Configurations => Transient => Step Source
    handles.tline_settings_file_preconfig_transient_step = uimenu(...
        'Parent',handles.tline_settings_file_preconfig_transient,...
        'Label','Step',...
        'Accelerator','1',...
        'Callback',@tline_settings_file_preconfig_transient_step_callback);
    
    % File => Predefined Configurations => Transient => Ramped Step Source
    handles.tline_settings_file_preconfig_transient_ramped_step = uimenu(...
        'Parent',handles.tline_settings_file_preconfig_transient,...
        'Label','Ramped Step',...
        'Accelerator','2',...
        'Callback',@tline_settings_file_preconfig_transient_ramped_step_callback);
    
    % File => Predefined Configurations => Transient => Sinusoidal Source
    handles.tline_settings_file_preconfig_transient_sine = uimenu(...
        'Parent',handles.tline_settings_file_preconfig_transient,...
        'Label','Sine',...
        'Accelerator','3',...
        'Callback',@tline_settings_file_preconfig_transient_sine_callback);
    
    % File => Predefined Configurations => Steady State
    handles.tline_settings_file_preconfig_steady_state = uimenu(...
        'Parent',handles.tline_settings_file_preconfig,...
        'Label','Steady State');
    
    % File => Predefined Configurations => Steady State => Sinusoidal Source
    handles.tline_settings_file_preconfig_steady_state_sine = uimenu(...
        'Parent',handles.tline_settings_file_preconfig_steady_state,...
        'Label','Sine',...
        'Accelerator','4',...
        'Callback',@tline_settings_file_preconfig_steady_state_sine_callback);
    
    % File => Close
    handles.tline_settings_file_close = uimenu(...
        'Parent',handles.tline_settings_file,...
        'Label','Close',...
        'Separator','on',...
        'Accelerator','q',...
        'Callback',@tline_settings_file_close_callback);
    
     %% Create Transmission Line Settings Source Menu
    
    % Source => Source Selection Panel
    handles.tline_settings_source_panel = uimenu(...
        'Parent',handles.tline_settings_source,...
        'Label','Source Selection Panel',...
        'Checked','off',...
        'UserData',0,...
        'Callback',@tline_settings_source_panel_callback);
    
    % Source => Step
    handles.tline_settings_source_step = uimenu(...
        'Parent',handles.tline_settings_source,...
        'Label','Step',...
        'Checked','on',...
        'UserData',1,...
        'Separator','on',...
        'Callback',@tline_settings_source_step_callback);
    
    % Source => Ramped Step
    handles.tline_settings_source_ramped_step = uimenu(...
        'Parent',handles.tline_settings_source,...
        'Label','Ramped Step',...
        'Checked','off',...
        'UserData',0,...
        'Callback',@tline_settings_source_ramped_step_callback);
    
    % Source => Sine
    handles.tline_settings_source_sine = uimenu(...
        'Parent',handles.tline_settings_source,...
        'Label','Sine',...
        'Checked','off',...
        'UserData',0,...
        'Callback',@tline_settings_source_sine_callback);
    
   
     %% Create Transmission Line Settings Line Menu
       
    % Line => Lossless
    handles.tline_settings_line_lossless = uimenu(...
        'Parent',handles.tline_settings_line,...
        'Label','Lossless',...
        'Checked','on',...
        'UserData',1,...
        'Callback',@tline_settings_line_lossless_callback);
    
    % Line => Lossy
    handles.tline_settings_line_lossy = uimenu(...
        'Parent',handles.tline_settings_line,...
        'Label','Lossy',...
        'Checked','off',...
        'UserData',0,...
        'Callback',@tline_settings_line_lossy_callback);
    ...
    % Animation => Transient
    handles.tline_settings_animation_transient = uimenu(...
        'Parent',handles.tline_settings_animation,...
        'Label','Transient',...
        'Checked','on',...
        'UserData',1,...
        'Callback',@tline_settings_animation_transient_callback);
    
    % Animation => Steady State
    handles.tline_settings_animation_steady_state = uimenu(...
        'Parent',handles.tline_settings_animation,...
        'Label','Steady State',...
        'Checked','off',...
        'UserData',0,...
        'Callback',@tline_settings_animation_steady_state_callback);
    
    % Animation => Animation Settings
    handles.tline_settings_animation_settings = uimenu(...
        'Parent',handles.tline_settings_animation,...
        'Label','Animation Settings',...
        'Checked','on',...
        'UserData',1,...
        'Separator','on',...
        'Callback',@tline_settings_animation_settings_callback);
    
    % Animation => Animation Slider
    handles.tline_settings_animation_slider = uimenu(...
        'Parent',handles.tline_settings_animation,...
        'Label','Animation Slider',...
        'Checked','off',...
        'UserData',0,...
        'Callback',@tline_settings_animation_slider_callback);
    
    
    %% Create Transmission Line Settings Help Menu
    
    % Animation => Show Calculations
    handles.tline_settings_help_calculations = uimenu(...
        'Parent',handles.tline_settings_help,...
        'Label','Show Calculations',...
        'Checked','off',...
        'UserData',0,...
        'Callback',@tline_settings_help_calculations_callback);
    
    % Animation => Simulation Notes
    handles.tline_settings_help_notes = uimenu(...
        'Parent',handles.tline_settings_help,...
        'Label','Simulation Notes',...
        'Checked','off',...
        'UserData',0,...
        'Separator','on',...
        'Callback',@tline_settings_help_notes_callback);
